...
IF OBJECT_ID('master.Module') IS NOT NULL
    ...
    WHERE ModuleId IN ('esic', 'cghs', 'echs', 'statescheme', 'claimsmis', 'occhealth', 'telemedicine', 'ambulance', 'diet', 'mortuary', 'consent', 'payroll', 'feedback', 'compliance', 'assets', 'multibranch');
GO
